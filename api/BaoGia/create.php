...
if (!isset($data->TenBaoGia, $data->MaLead, $data->HoTenLead, $data->TongTienTruocGiam, $data->TongTien, $data->TrangThaiBaoGia)) {
...
$baoGia->TrangThaiBaoGia = $data->TrangThaiBaoGia;
$baoGia->TaoVaoLuc = date('Y-m-d H:i:s');
$baoGia->TaoBoi = 1; // Fix cứng
$baoGia->ChinhSuaLanCuoiVaoLuc = date('Y-m-d H:i:s'); // Use TaoVaoLuc for ChinhSuaLanCuoiVaoLuc
$baoGia->ChinhSuaLanCuoiBoi = 1; // Fix cứng
